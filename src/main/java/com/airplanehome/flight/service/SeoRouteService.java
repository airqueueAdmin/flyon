...
public class SeoRouteService {
    ...
    public SeoRouteService() {
        ...
        register(new SeoRoute(
            ...
            "후쿠오카",
            "Fukuoka",
            "후쿠오카 항공권 최저가 | 실시간 가격 추적 알림",
            "후쿠오카 항공권 최저가를 실시간으로 확인하고, 가격이 내려갈 때 바로 알림을 받을 수 있는 서비스입니다.",
        ...
        register(new SeoRoute(
            ...
            "도쿄 나리타",
            "Tokyo",
            "도쿄 항공권 최저가 | 실시간 특가 알림",
            "도쿄 항공권 최저가를 실시간으로 확인하고, 특가 시점에 바로 알림을 받을 수 있는 서비스입니다.",
        ...
        register(new SeoRoute(
            ...
            "오사카 간사이",
            "Osaka",
            "오사카 항공권 최저가 | 주말 특가 알림",
            "오사카 항공권 최저가를 실시간으로 확인하고, 주말 특가 시점에 바로 알림을 받을 수 있는 서비스입니다.",
        ...
        register(new SeoRoute(
            ...
            "방콕",
            "Bangkok",
            "방콕 항공권 최저가 | 동남아 특가 알림",
            "방콕 항공권 최저가를 실시간으로 확인하고, 가격이 내려갈 때 바로 알림을 받을 수 있는 서비스입니다.",
        ...
        register(new SeoRoute(
            ...
            "타이베이",
            "Taipei",
            "타이베이 항공권 최저가 | 대만 특가 알림",
            "타이베이 항공권 최저가를 실시간으로 확인하고, 대만 특가 시점에 바로 알림을 받을 수 있는 서비스입니다.",
        ...
        register(new SeoRoute(
            ...
            "홍콩",
            "Hong Kong",
            "홍콩 항공권 최저가 | 도시 여행 특가 알림",
            "홍콩 항공권 최저가를 실시간으로 확인하고, 특가 시점에 바로 알림을 받을 수 있는 서비스입니다.",
            "짧은 일정으로 많이 가는 노선이라 바로 추적해 두기 좋습니다.",
            "도시 여행, 미식 여행, 짧은 휴가",
            "출발 2~7주 전부터 체크",
            "홍콩 최저가 보기",
        ...
        register(new SeoRoute(
            ...
            "싱가포르",
            "Singapore",
            "싱가포르 항공권 최저가 | 도시 여행 특가 알림",
            "싱가포르 항공권 최저가를 실시간으로 확인하고, 특가 시점에 바로 알림을 받을 수 있는 서비스입니다.",
        ...
        register(new SeoRoute(
            ...
            "다낭",
            "Da Nang",
            "다낭 항공권 최저가 | 휴양지 특가 알림",
            "다낭 항공권 최저가를 실시간으로 확인하고, 휴가 시즌 특가 시점에 바로 알림을 받을 수 있는 서비스입니다.",
        ...
        register(new SeoRoute(
            ...
            "호치민",
            "Ho Chi Minh City",
            "호치민 항공권 최저가 | 베트남 특가 알림",
            "호치민 항공권 최저가를 실시간으로 확인하고, 특가 시점에 바로 알림을 받을 수 있는 서비스입니다.",
        ...
        register(new SeoRoute(
            ...
            "로스앤젤레스",
            "Los Angeles",
            "로스앤젤레스 항공권 최저가 | LA 미주 특가 알림",
            "LA 항공권 최저가를 실시간으로 확인하고, 미주 특가 시점에 바로 알림을 받을 수 있는 서비스입니다.",
        ...
        register(new SeoRoute(
            ...
            "샌프란시스코",
            "San Francisco",
            "샌프란시스코 항공권 최저가 | 미국 서부 특가 알림",
            "샌프란시스코 항공권 최저가를 실시간으로 확인하고, 미국 서부 특가 시점에 바로 알림을 받을 수 있는 서비스입니다.",
        ...
        register(new SeoRoute(
            ...
            "뉴욕",
            "New York",
            "뉴욕 항공권 최저가 | 장거리 특가 알림",
            "뉴욕 항공권 최저가를 실시간으로 확인하고, 장거리 특가 시점에 바로 알림을 받을 수 있는 서비스입니다.",
        ...
        register(new SeoRoute(
            ...
            "London",
            "런던 항공권 최저가 | 유럽 특가 알림",
            "런던 항공권 최저가를 실시간으로 확인하고, 유럽 특가 시점에 바로 알림을 받을 수 있는 서비스입니다.",
        ...
        register(new SeoRoute(
            ...
            "Paris",
            "파리 항공권 최저가 | 유럽 특가 알림",
            "파리 항공권 최저가를 실시간으로 확인하고, 유럽 특가 시점에 바로 알림을 받을 수 있는 서비스입니다.",
